    ...
    <div>
      <div className="container">
        <div className="d-flex justify-content-center flex-wrap">
          ...
          <Card className="col-9 col-lg-3">
            <Card.Img variant="top" src="https://i.postimg.cc/kgDnHD2Z/20200501-140854.jpg" className="px-2 py-2"/>
            <Card.Body>
          ...
          <Card className="col-9 col-lg-3">
            <Card.Img variant="top" src="https://i.postimg.cc/s2vv5wPM/20220721-100843-1.jpg" className="px-2 py-2"/>
            <Card.Body>
